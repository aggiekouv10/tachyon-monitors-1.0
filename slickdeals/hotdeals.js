...
const discordWebhook = new webhook.Webhook(discordBot.webhooks.HOTDEALS);
const CHANNEL = discordBot.channels.HOTDEALS
...
async function startMonitoring() {
  monitor()
  console.log('[Hotdeals] Monitoring!')
}

async function monitor() {
    fetch("https://slickdeals.net/forums/forumdisplay.php?f=9").then(async response => {
...
async function postRestockWebhook(url, name) {
  var webhookMessage = new webhook.MessageBuilder()
    ...
    .addField("**Posted In**", '[Hotdeals](https://slickdeals.net/forums/forumdisplay.php?f=9)', true)
