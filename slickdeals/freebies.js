...
const discordWebhook = new webhook.Webhook(discordBot.webhooks.FREEBIES);
const CHANNEL = discordBot.channels.FREEBIES
...
async function startMonitoring() {
  monitor()
  console.log('[Freebies] Monitoring!')
}

async function monitor() {

    fetch("https://slickdeals.net/forums/forumdisplay.php?f=4").then(async response => {
...
async function postRestockWebhook(url, name) {
  var webhookMessage = new webhook.MessageBuilder()
    ...
    .addField("**Posted In**", '[Freebies](https://slickdeals.net/forums/forumdisplay.php?f=4)', true)
