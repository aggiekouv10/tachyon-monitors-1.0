...
const space = new webhook.Webhook('https://discord.com/api/webhooks/975541762204524575/7etIwD8VjSw1X1PRbGKzwi-6P4NN_xR9DWNrvjhqvnMARHtgiMTp_hfSQFYyYBpBdEnx');
const drop = new webhook.Webhook('https://discord.com/api/webhooks/915337860226371614/oeUTLwdIpqw9Y2T__X1K0AWHCLQtD13P-nC4a7a8IFIFsEVXYBPdbqEg7EZy_6Ti_XXW');
const helper = require('../helper');
let status = false
const { v4 } = require('uuid');
const DATABASE_TABLE = 'footlocker';
const SITENAME = 'FOOTLOCKER'
...
async function monitor(sku) {
    ...
    fetch(`https://www-footlocker-com.translate.goog/zgw/product-core/v1/pdp/sku/${sku}?_x_tr_sl=en&_x_tr_tl=el&_x_tr_hl=en&_x_tr_pto=wapp`, {
        'headers': {
        ...
        if (body.inventory.inventoryAvailable == true) {
            ...
            let url = `https://www.footlocker.com/product/~/${sku}.html#Tachyon`
            let sizes = []
...
async function postRestockWebhook(url, title, sku, price, image, sizeright, sizeleft, count) {
    var zephyraio = `https://api.zephyraio.com/api/quicktask?url=https://www.footlocker.com/product/~/${sku}.html`
    ...
    var kylin = `https://dashboard.kylinbot.io/quick-task/kylin-bot/create?input=https://www.footlocker.com/product/~/${sku}.html&sku=${sku}`
    ...
    var MekAIO = `https://dashboard.mekrobotics.com/quicktask?link=https://www.footlocker.com/product/~/${sku}.html&sku=${sku}`
    var wrath = 'https://whatbot.club/redirect-qt?qt=whatbot://https://www.footlocker.com/product/~/' + sku + '.html'
    var hayha = `http://localhost:7447/qt?url=https://www.footlocker.com/product/~/${sku}.html`
    var venetia = `http://localhost:4444/quicktask?storetype=Footsites&input=https://www.footlocker.com/product/~/${sku}.html`
    var kage = `http://localhost:1007/quickTasks?site=footlocker&sku=${sku}`
...
async function monitorQueue() {
  ...
  async function monitorQueue() {
    var webhookMessage = new webhook.MessageBuilder()
      .setName("Tachyon Monitors")
      .setColor("#6cb3e3")
      .setTitle('Footlocker Queu is now live!')
      .setURL('https://www.footlocker.com')
      .setAuthor('https://www.footlocker.com', '', 'https://www.footlocker.com')
      .setThumbnail('https://c.tenor.com/3t9-P1Zh18YAAAAC/foot-locker.gif')
      .setAvatar("https://media.discordapp.net/attachments/820804762459045910/821401274053820466/Copy_of_Copy_of_Copy_of_Copy_of_Untitled_5.png?width=829&height=829")
      .setTime()
      .setFooter("Footlocker US | v2.0", 'https://media.discordapp.net/attachments/820804762459045910/821401274053820466/Copy_of_Copy_of_Copy_of_Copy_of_Untitled_5.png?width=829&height=829')
    discordWebhook.send(webhookMessage);
