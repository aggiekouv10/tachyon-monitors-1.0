...
let webhooks = [
    new webhook.Webhook('https://discord.com/api/webhooks/850458129669947462/hAqClA4k790YDyBIT8BaRpaPCQ3eTe1XAVu-NerOaJUZbmugru_k8fa3ewdyhZOb1_3n')
]
...
async function monitor(listIndex) {
    ...
    try {
        console.log("Sending..")
        let response = await axios('https://www.walmart.ca/api/product-page/v2/price-offer', {
            method: "POST",
            headers: {
                'user-agent': 'Android v18.15.1',
            ...
            agent: new HTTPSProxyAgent(proxy),
 signal: controller.signal,
            data: { "fsa": "L5V", "products": [{ "productId": `${randomSKU}`, "skuIds": skus }], "lang": "en", "pricingStoreId": '1061', "fulfillmentStoreId": "1061", "experience": "whiteGM" },
