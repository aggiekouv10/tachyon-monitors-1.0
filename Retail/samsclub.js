...
const discordWebhook = new webhook.Webhook(discordBot.webhooks.SAMSCLUB);
const spacehook = new webhook.Webhook('https://discord.com/api/webhooks/912570155538726933/ke-KGspg_nqk1rurXvN9CMdGX5FuMD3S29oFerOz7VoA6k5Sc0kguEcZm63kThchU0xj');
const CHANNEL = discordBot.channels.SAMSCLUB;
const helper = require('../helper');
const DATABASE_TABLE = 'samsclub';
const { v4 } = require('uuid');
const { Console } = require('console');
const SITENAME = 'SAMSCLUB'
let stats;
...
async function startMonitoring() {
    ...
    console.log('[SAMSCLUB] Monitoring all SKUs!')
}
async function monitor(sku) {
    let url = `https://www.samsclub.com/p/tachyon/${sku}`;
    ...
    fetch(`https://api-samsclub-com.translate.goog/v2/az/products/${sku}?type=PRODUCT_CARD&_x_tr_sl=auto&_x_tr_tl=en&_x_tr_hl=en-US&_x_tr_pto=nui`, {
        'headers': {
        ...
        if (body.payload.skus[0].onlineOffer && body.payload.skus[0].onlineOffer.inventory.availableToSellQuantity > 0) {
            ...
            let prices = body.payload.skus[0].onlineOffer.price.finalPrice.amount;
            let price = '$' + prices
...
async function postRestockWebhook(url, title, sku, price, image, stock) {
    ...
    var webhookMessage = new webhook.MessageBuilder()
        ...
        .setTitle(title)
        .setURL(url)
        .setAuthor('https://www.samsclub.com', '', 'https://www.samsclub.com')
        ...
        // .setTime()
        .setFooter("Sams Club | v1.0 • " + helper.getTime(true), 'https://media.discordapp.net/attachments/820804762459045910/821401274053820466/Copy_of_Copy_of_Copy_of_Copy_of_Untitled_5.png?width=829&height=829')
