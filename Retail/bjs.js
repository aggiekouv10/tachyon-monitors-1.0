...
const discordWebhook = new webhook.Webhook(discordBot.webhooks.BJS);
...
const CHANNEL = discordBot.channels.BJS;
const helper = require('../helper');
const DATABASE_TABLE = 'bjs';
...
async function startMonitoring() {
    ...
    console.log('[BJS] Monitoring all SKUs!')
}
