...
const discordWebhook = new webhook.Webhook(discordBot.webhooks.FOOTLOCKERNL);
const helper = require('../../helper');
let site = 'https://www.footlocker.nl'
startMonitoring();
let PRODUCTS = [];
...
async function startMonitoring() {
  monitor()
  console.log('[Footlocker-NL-Releases] Monitoring!')
}
