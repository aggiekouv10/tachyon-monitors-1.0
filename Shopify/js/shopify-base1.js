...
const SHOPIFY_UNFILTERED_HOOK = new webhook.Webhook(discordBot.webhooks.UNFILTERED1);
const SHOPIFY_FILTERED_HOOK = new webhook.Webhook(discordBot.webhooks.FILTERED1);
const SHOPIFY_UNFILTERED_HOOK2 = new webhook.Webhook('https://discord.com/api/webhooks/990463384875040860/6PZ-IAPgHjz3Lo019C7s13u-FB_5ZchBcDjy15UwpCcHQtU6uxWxtJoEYEbPOPuff8yV');
...
async function postRestockWebhook(discordWebhook, website, url, title, type, sizes, oldSizes, price, image, time) {
    ...
    var webhookMessage = new webhook.MessageBuilder()
        ...
        //   .setTime()
        .setFooter("Shopify | v0.9 | " + time, 'https://cdn.discordapp.com/attachments/973659244723310643/983215242668539934/win.png')
    try {
