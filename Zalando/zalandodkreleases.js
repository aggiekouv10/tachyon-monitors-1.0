...
const discordWebhook = new webhook.Webhook(discordBot.webhooks.ZALANDODK);
const helper = require('../helper');
let site = 'https://www.zalando.dk'
startMonitoring();
let PRODUCTS = [];
...
async function startMonitoring() {
  monitor()
  console.log('[Zalando-DK-Releases] Monitoring!')
}

async function monitor() {
  const controller = new AbortController();
    const timeoutId = setTimeout(() => controller.abort(), 4000)
    fetch(`${site}/herresko/?order=activation_date`, {
    'headers': {
