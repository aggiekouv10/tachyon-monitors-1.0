...
const discordWebhook = new webhook.Webhook(discordBot.webhooks.ZALANDOES);
const helper = require('../helper');
let site = 'https://www.zalando.es'
startMonitoring();
let PRODUCTS = [];
...
async function startMonitoring() {
  monitor()
  console.log('[Zalando-ES-Releases] Monitoring!')
}

async function monitor() {
  const controller = new AbortController();
    const timeoutId = setTimeout(() => controller.abort(), 4000)
    fetch(`${site}/calzado-hombre/?order=activation_date`, {
    'headers': {
