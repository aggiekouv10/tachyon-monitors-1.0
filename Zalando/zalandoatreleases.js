...
const discordWebhook = new webhook.Webhook(discordBot.webhooks.ZALANDOAT);
const helper = require('../helper');
let site = 'https://www.zalando.at'
startMonitoring();
let PRODUCTS = [];
...
async function startMonitoring() {
  monitor()
  console.log('[Zalando-AT-Releases] Monitoring!')
}

async function monitor() {
  const controller = new AbortController();
    const timeoutId = setTimeout(() => controller.abort(), 4000)
    fetch(`${site}/herrenschuhe/?order=activation_date`, {
    'headers': {
