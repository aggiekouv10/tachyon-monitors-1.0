...
const discordWebhook = new webhook.Webhook(discordBot.webhooks.ZALANDOBE);
const helper = require('../helper');
let site = 'https://www.zalando.be'
startMonitoring();
let PRODUCTS = [];
...
async function startMonitoring() {
  monitor()
  console.log('[Zalando-BE-Releases] Monitoring!')
}

async function monitor() {
  const controller = new AbortController();
    const timeoutId = setTimeout(() => controller.abort(), 4000)
    fetch(`${site}/herenschoenen/?order=activation_date`, {
    'headers': {
