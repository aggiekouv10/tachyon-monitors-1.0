...
const discordWebhook = new webhook.Webhook(discordBot.webhooks.ZALANDOIE);
const helper = require('../helper');
let site = 'https://www.zalando.ie'
startMonitoring();
let PRODUCTS = [];
...
async function startMonitoring() {
  monitor()
  console.log('[Zalando-IE-Releases] Monitoring!')
}

async function monitor() {
  const controller = new AbortController();
    const timeoutId = setTimeout(() => controller.abort(), 4000)
    fetch(`${site}/shoes/?order=activation_date`, {
    'headers': {
