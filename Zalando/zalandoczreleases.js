...
const discordWebhook = new webhook.Webhook(discordBot.webhooks.ZALANDOCZ);
const helper = require('../helper');
let site = 'https://www.zalando.cz'
startMonitoring();
let PRODUCTS = [];
...
async function startMonitoring() {
  monitor()
  console.log('[Zalando-CZ-Releases] Monitoring!')
}

async function monitor() {
  const controller = new AbortController();
    const timeoutId = setTimeout(() => controller.abort(), 4000)
    fetch(`${site}/panske-boty/?order=activation_date`, {
    'headers': {
