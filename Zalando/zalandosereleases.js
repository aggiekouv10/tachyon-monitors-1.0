...
const discordWebhook = new webhook.Webhook(discordBot.webhooks.ZALANDOSE);
const helper = require('../helper');
let site = 'https://www.zalando.se'
startMonitoring();
let PRODUCTS = [];
...
async function startMonitoring() {
  monitor()
  console.log('[Zalando-SE-Releases] Monitoring!')
}

async function monitor() {
  const controller = new AbortController();
    const timeoutId = setTimeout(() => controller.abort(), 4000)
    fetch(`${site}/herrskor/?order=activation_date`, {
    'headers': {
