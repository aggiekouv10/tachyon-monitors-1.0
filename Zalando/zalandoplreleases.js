...
const discordWebhook = new webhook.Webhook(discordBot.webhooks.ZALANDOPL);
const helper = require('../helper');
let site = 'https://www.zalando.pl'
startMonitoring();
let PRODUCTS = [];
...
async function startMonitoring() {
  monitor()
  console.log('[Zalando-PL-Releases] Monitoring!')
}

async function monitor() {
  const controller = new AbortController();
    const timeoutId = setTimeout(() => controller.abort(), 4000)
    fetch(`${site}/obuwie-meskie/?order=activation_date`, {
    'headers': {
