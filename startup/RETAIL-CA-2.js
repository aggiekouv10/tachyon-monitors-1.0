...
discordBot.login();
let neweggca = require('../Retail/newegg-ca')
let canadacomputers = require('../Retail/canada-computers');
let toysrusca = require('../Retail/toysrus-ca')
let toysruscastore = require('../Retail/toys-r-us-store');
