...
const discordWebhook = new webhook.Webhook(discordBot.webhooks.ADIDASCL);
const helper = require('../helper');
const { v4 } = require('uuid');
const urlbase = 'https://www.adidas.cl'
const currency = ' (CLP)'
...
async function startMonitoring() {
  monitor(true)
  console.log('[ADIDAS-CL] Monitoring!')
}
...
async function monitor(justStarted) {
  ...
  const controller = new AbortController();
    ...
    fetch(`${urlbase}/api/plp/content-engine?query=calzado-novedades&abcz=${v4()}`, {
    'headers': {
