...
const discordWebhook = new webhook.Webhook(discordBot.webhooks.ADIDASCA);
const spacehook = new webhook.Webhook('https://discord.com/api/webhooks/912558584565469225/l86I63Py2_AVACQ0_NvUlDyUEv8VztFjFDObFl8oLfiI4y4dcCIJhLhPK99sR3znfPya');
const helper = require('../helper');
const { v4 } = require('uuid');
const urlbase = 'https://www.adidas.ca'
const currency = ' (CAD)'
...
signal: controller.signal
    ...
    let json = root.querySelector('script').textContent.split('window.ENV = ').join('').trim()
...
signal: controller.signal
        ...
        clearTimeout(timeoutId)
          ...
          console.log(body.availability_status)
