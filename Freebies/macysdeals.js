...
const discordWebhook = new webhook.Webhook(discordBot.webhooks.MACYS);
const space = new webhook.Webhook('https://discord.com/api/webhooks/976327899894386688/-ow4ELTpaaow-egW98gcDVopX_6WO1ZONDyNU-PFXEAW8v6__FXT7QSK1ss6QsTjdx72');
const CHANNEL = discordBot.channels.MACYS;
...
async function monitor() {
    ...
    fetch(`https://yofreesamples.com/deals-promos-online/best-macys-online-deals-for-today/?_sort=date_desc&abcz=${v4()}`, {
        'headers': {
...
async function postRestockWebhook(url, name, image, online, msrp, percent, promocode) {
    var webhookMessage = new webhook.MessageBuilder()
        ...
        .setTime()
        .setFooter(" Macy's Deals | v1.0", 'https://media.discordapp.net/attachments/820804762459045910/821401274053820466/Copy_of_Copy_of_Copy_of_Copy_of_Untitled_5.png?width=829&height=829')
