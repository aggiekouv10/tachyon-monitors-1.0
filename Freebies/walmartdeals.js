...
const discordWebhook = new webhook.Webhook(discordBot.webhooks.WALMARTDEALS);
const space = new webhook.Webhook('https://discord.com/api/webhooks/976328132611170345/NbgmI6JW5fLmeOG8v4t0gZFUJx0_NAWX7TZ5jdDBMJQE06tv_lzWpeexw7P8sYx3x75p');
const CHANNEL = discordBot.channels.WALMARTDEALS;
...
async function startMonitoring() {
    monitor()
    console.log('[WALMARTDEALS] Monitoring!')
}
...
async function monitor() {
    ...
    fetch(`https://yofreesamples.com/deals-promos-online/best-walmart-deals-right-now-today-online/?_sort=date_desc&abcz=${v4()}`, {
        'headers': {
        ...
        for (let product of products) {
            ...
            if (!PRODUCTS.includes(name)) {
                ...
                let url = product.querySelector('.offer_button.button.external_link_button').attributes.href.replace('?_encoding=UTF8&tag=yofreeoffer-20&linkCode=ogi&th=1&psc=1','')
...
async function postRestockWebhook(url, name, image, online, msrp, percent, promocode) {
    var webhookMessage = new webhook.MessageBuilder()
        ...
        .setTime()
        .setFooter(" Walmart Deals | v1.0", 'https://media.discordapp.net/attachments/820804762459045910/821401274053820466/Copy_of_Copy_of_Copy_of_Copy_of_Untitled_5.png?width=829&height=829')
