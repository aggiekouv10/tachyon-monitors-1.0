...
const discordWebhook = new webhook.Webhook(discordBot.webhooks.BESTBUYDEALS);
const space = new webhook.Webhook('https://discord.com/api/webhooks/976327729668571166/du4EgqAvCGhkDVFFZev4nxZFJ-vpPdYgr3UMUZWgNbwxJa7WOUKp7FCp-YwqsOOunz1e');
const CHANNEL = discordBot.channels.BESTBUYDEALS;
...
async function startMonitoring() {
    monitor()
    console.log('[BESTBUYDEALS] Monitoring!')
}
...
async function monitor() {
    ...
    fetch(`https://yofreesamples.com/store/best-buy/?_sort=date_desc&abcz=${v4()}`, {
        'headers': {
...
async function postRestockWebhook(url, name, image, online, msrp, percent, promocode) {
    var webhookMessage = new webhook.MessageBuilder()
        ...
        .setTime()
        .setFooter(" Bestbuy Deals | v1.0", 'https://media.discordapp.net/attachments/820804762459045910/821401274053820466/Copy_of_Copy_of_Copy_of_Copy_of_Untitled_5.png?width=829&height=829')
