...
const discordWebhook = new webhook.Webhook(discordBot.webhooks.TARGETDEALS);
const space = new webhook.Webhook('https://discord.com/api/webhooks/976327954047053834/jsRRTkqFJDF-Sp4TtcfDSWDRD2wOeUl2u5cTDjt4sji_a0hxcjhvMMUOKmUBHbWukF6j');
const CHANNEL = discordBot.channels.TARGETDEALS;
...
async function startMonitoring() {
    monitor()
    console.log('[TARGETDEALS] Monitoring!')
}
...
async function postRestockWebhook(url, name, image, online, msrp, percent, promocode) {
    var webhookMessage = new webhook.MessageBuilder()
        ...
        .setTime()
        .setFooter(" Target Deals | v1.0", 'https://media.discordapp.net/attachments/820804762459045910/821401274053820466/Copy_of_Copy_of_Copy_of_Copy_of_Untitled_5.png?width=829&height=829')
