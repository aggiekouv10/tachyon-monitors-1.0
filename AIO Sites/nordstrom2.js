...
const discordWebhook = new webhook.Webhook('https://discord.com/api/webhooks/994684078894874634/i7xOo7s47yvYx1TmXJS4RC7p23Mmk7186apuGQ9D_Azxj4GumVrDA7HH-7v1qw0k3ZOb');
...
//('https://discord.com/api/webhooks/972639129638690836/nmU31cklo1Cm47nY4hWDzw37cKkx0DrfP1zyKDp_pRXTsH2FAEJeemt5jwEZtLfFKb5Y');
...
const DATABASE_TABLE = 'nordstrom2';
const SITENAME = 'NORDSTROM'
const CHANNEL = '994681943939612672'
...
async function monitor(sku) {
    ...
    fetch(`https://www.nordstrom.com/api/style/${sku}?abcz=${v4()}`, {
        'headers': {
            'user-agent': 'Mozilla/5.0 (compatible; AhrefsBot/1.0; +http://ahrefs.com/robot/)',
...
async function cookologyhook(url, title, sku, price, image, sizeright, sizeleft, stock) {
    var webhookMessage = new webhook.MessageBuilder()
        ...
        .setFooter("Nordstrom by Tachyon | v2.0 • " + helper.getTime(true), 'https://media.discordapp.net/attachments/894983430952063047/894983493984088084/Group_41.png')
...
async function postRestockWebhook(url, title, sku, price, image, sizeright, sizeleft, stock) {
    ...
    var webhookMessage = new webhook.MessageBuilder()
        ...
        .setFooter("Nordstrom | v2.0 • " + helper.getTime(true), 'https://media.discordapp.net/attachments/820804762459045910/821401274053820466/Copy_of_Copy_of_Copy_of_Copy_of_Untitled_5.png?width=829&height=829')
...
async function postdrop(url, title, sku, price, image, sizeright, sizeleft, stock) {
    var webhookMessage = new webhook.MessageBuilder()
        ...
        .setFooter("Nordstrom | v2.0 • " + helper.getTime(true), 'https://cdn.discordapp.com/attachments/973659244723310643/983215242668539934/win.png')
...
async function postcopbox(url, title, sku, price, image, sizeright, sizeleft, stock) {
    var webhookMessage = new webhook.MessageBuilder()
        ...
        .setFooter("Nordstrom | v2.0 • " + helper.getTime(true), 'https://media.discordapp.net/attachments/804617985498546177/989026781023580190/Frame_1.jpg')
