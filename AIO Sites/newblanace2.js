...
////('https://discord.com/api/webhooks/972570196181139526/8f7P6Fs1zCF_aPbkf2y751BYAQ20F8fo6wataoZ_BBvNngQucV1BgNPN-llQ29VhOC3Z');
...
async function monitor(sku) {
    ...
    got(`https://api-newbalancev2.mobfiq.com.br/Search/Criteria`, {
        method: "POST",
        headers: {
                'User-Agent': randomUseragent.getRandom(), 
        },
        json:  {
            "RealProductId" : sku.split('-')[1],
        ...
        if (body.Products[0].Availability === true) {
            ...
            for (let variant of variants) {
                ...
                continue
                sizes += `[${variant.displayValue}](https://www.newbalance.com/${sku}.html#dwvar_${sku}_size=${variant.displayValue}&pid=${sku}&quantity=1)\n`
                count++
