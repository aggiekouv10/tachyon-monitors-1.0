...
request['defaults']({
    ...
    'url': 'https://www.nordstrom.com/s/yzy_500_brown_clay',
    ...
    'headers': {
        ...
        'cdn-loop': 'Fastly',
        'fastly-orig-accept-encoding': 'gzip,\x20deflate,\x20br',
        ...
        'fastly-ssl': '1',
        'true-client-ip': '91.72.205.49',
        'nord-country-code': 'US',
        'nord-source-channel': 'FULL_LINE',
        'x-forwarded-host': 'www.nordstrom.com'
        // 'cookie': this['cookieString']
    }}, (err, response, body) => {
            console.log(Date.now() - time)
            console.log(response.headers)
            console.log(response.statusCode)
            fs.writeFileSync('nord-test-json-5.html', body.toString())
