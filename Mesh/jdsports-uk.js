...
const discordWebhook = new webhook.Webhook(discordBot.webhooks.JDSPORTSUK);
const CHANNEL = discordBot.channels.JDSPORTSUK;
const helper = require('../helper');
const HTTPSProxyAgent = require('https-proxy-agent');

const DATABASE_TABLE = 'jdsportsuk';
let totalData = 0;
let errors = 0;

const SITE = 'jdsportsuk';
const URL = 'https://www.jdsports.co.uk';
const credentials = {
    id: 'd1bdff50c5',
    key: '3442497330233aecfe132ddfbbd4d46d',
    algorithm: 'sha256'
};
const API_KEY = '4CE1177BB983470AB15E703EC95E5285';
