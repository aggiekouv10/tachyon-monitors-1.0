...
const discordWebhook = new webhook.Webhook(discordBot.webhooks.SIZEDK);
const CHANNEL = discordBot.channels.SIZEDK;
const helper = require('../helper');
const HTTPSProxyAgent = require('https-proxy-agent');

const DATABASE_TABLE = 'sizedk';
let totalData = 0;
let errors = 0;

const SITE = 'sizedk';
const URL = 'https://www.sizeofficial.dk';
const credentials = {
    id: '6af2364998',
    key: '6f81172915d84691817dd22040f0b4f9',
    algorithm: 'sha256'
};
const API_KEY = '4E728C6150EE4396A8BACB0DD627DA2F';
